...
exports.paginateListStudioLifecycleConfigs = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new ListStudioLifecycleConfigsCommand_1.ListStudioLifecycleConfigsCommand(input), ...args);
};
async function* paginateListStudioLifecycleConfigs(config, input, ...additionalArguments) {
