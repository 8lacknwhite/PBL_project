...
export declare class CreateAutoMLJobV2Command extends $Command<CreateAutoMLJobV2CommandInput, CreateAutoMLJobV2CommandOutput, SageMakerClientResolvedConfig> {
     ...
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: SageMakerClientResolvedConfig, options?: __HttpHandlerOptions): Handler<CreateAutoMLJobV2CommandInput, CreateAutoMLJobV2CommandOutput>;
    /**
     * @internal
     */
    private serialize;
