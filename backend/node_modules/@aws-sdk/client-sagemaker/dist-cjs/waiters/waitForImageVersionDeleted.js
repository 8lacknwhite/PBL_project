...
exports.waitUntilImageVersionDeleted = exports.waitForImageVersionDeleted = void 0;
const util_waiter_1 = require("@aws-sdk/util-waiter");
const DescribeImageVersionCommand_1 = require("../commands/DescribeImageVersionCommand");
const checkState = async (client, input) => {
    let reason;
    try {
        const result = await client.send(new DescribeImageVersionCommand_1.DescribeImageVersionCommand(input));
        reason = result;
        try {
