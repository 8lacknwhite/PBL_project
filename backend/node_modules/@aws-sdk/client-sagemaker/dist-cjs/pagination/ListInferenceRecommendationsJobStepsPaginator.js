...
exports.paginateListInferenceRecommendationsJobSteps = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new ListInferenceRecommendationsJobStepsCommand_1.ListInferenceRecommendationsJobStepsCommand(input), ...args);
};
async function* paginateListInferenceRecommendationsJobSteps(config, input, ...additionalArguments) {
