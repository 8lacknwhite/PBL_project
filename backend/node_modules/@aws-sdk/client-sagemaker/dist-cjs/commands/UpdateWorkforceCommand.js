...
class UpdateWorkforceCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_4_1.UpdateWorkforceRequestFilterSensitiveLog,
    ...
    serialize(input, context) {
        return (0, Aws_json1_1_1.se_UpdateWorkforceCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_json1_1_1.de_UpdateWorkforceCommand)(output, context);
    }
}
